...
import { Plus, Minus, Zap, ShieldCheck, Clock, Users, ArrowRight, Loader2 } from 'lucide-react'
        ...
        <section className="pt-32 pb-24 px-4 bg-transparent relative overflow-hidden transition-colors duration-500">
            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                    ...
                    {/* BAGIAN KIRI (STICKY CARD) - TIDAK BERUBAH */}
                    ...
                    {/* BAGIAN KANAN (ACCORDION FAQ) - MENGGUNAKAN DATA SUPABASE */}
                    <div className="lg:col-span-7 flex flex-col justify-center order-1 lg:order-2">
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-4">
                                {/* MAPPING DATA DARI STATE 'faqs' */}
                                {faqs.map((faq, index) => (
                                    <ScrollReveal key={faq.id} delay={0.1 + (index * 0.1)} fullWidth>
                                        <div 
                                            className={`
