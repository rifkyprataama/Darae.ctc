...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-32 pb-10 px-6 bg-transparent border-t border-gray-200 dark:border-white/10 overflow-hidden transition-colors duration-500">
      ...
      {/* BACKGROUND DECOR (Glow Accent di Footer) */}
          ...
          <ScrollReveal direction="up" delay={0.3} fullWidth>
              <div className="flex flex-col md:flex-row gap-12 lg:justify-end items-start lg:pt-4">
                ...
                <div className="space-y-6">
                    <h4 className="font-bold uppercase tracking-widest text-xs text-darae-charcoal/50 dark:text-gray-500 mb-6">Drop us a line</h4>
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-lg text-darae-charcoal/70 dark:text-gray-400 mt-2">+62 812 3456 7890</p>
                ...
                <div className="space-y-6 min-w-[120px]">
                    ...
                    <ul className="space-y-3 font-medium text-lg">
                        ...
                        <li><Magnetic><a href="#pricing" className="inline-block text-darae-charcoal dark:text-white hover:text-darae-accent dark:hover:text-darae-blue transition-colors">Services</a></Magnetic></li>
                        <li><Magnetic><a href="#portfolio" className="inline-block text-darae-charcoal dark:text-white hover:text-darae-accent dark:hover:text-darae-blue transition-colors">Work</a></Magnetic></li>
                    </ul>
                </div>

                {/* Social Media */}
                <div className="space-y-6 min-w-[120px]">
                    <h4 className="font-bold uppercase tracking-widest text-xs text-darae-charcoal/50 dark:text-gray-500 mb-4">Follow</h4>
                    <ul className="space-y-3 font-medium text-lg">
                        <li><Magnetic><a href="#" className="inline-block text-darae-charcoal dark:text-white hover:text-darae-accent dark:hover:text-darae-blue transition-colors">Instagram</a></Magnetic></li>
                        <li><Magnetic><a href="#" className="inline-block text-darae-charcoal dark:text-white hover:text-darae-accent dark:hover:text-darae-blue transition-colors">LinkedIn</a></Magnetic></li>
                        <li><Magnetic><a href="#" className="inline-block text-darae-charcoal dark:text-white hover:text-darae-accent dark:hover:text-darae-blue transition-colors">Dribbble</a></Magnetic></li>
                        <li><Magnetic><a href="#" className="inline-block text-darae-charcoal dark:text-white hover:text-darae-accent dark:hover:text-darae-blue transition-colors">GitHub</a></Magnetic></li>
                    </ul>
                </div>
