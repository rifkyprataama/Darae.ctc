      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-4 overflow-hidden pt-20">
        ...
        <div className="flex items-center gap-4 animate-fadeIn">
              ...
              {avatars.map((_, index) => (
                  <div 
                      ...
                      className="
                          ...
                          border-2 border-white dark:border-darae-charcoal
                          shadow-md z-10
                      "
                  >
                      {/* Icon User SVG Putih */}
          ...
          <div className="text-left">
              <p className="text-base md:text-lg font-bold text-darae-charcoal dark:text-gray-200">
                  Klien
              </p>
          </div>
